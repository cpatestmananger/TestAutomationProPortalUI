...
{
    [TestClass]
    public class TestEmployeeAccountsWebPart
    {
        ...
        [TestMethod]     
        public void TestOldestOpenPeriod()
        {
            ...
            EmployeeAccountsUtils.selectPeriodType(driver, 1);

            Thread.Sleep(3000);

            EmployeeAccountsUtils.checkBalance(driver, "1:00");
        ...
        public void TestCurrentOpenPeriod()
        {
            ...
            EmployeeAccountsUtils.selectPeriodType(driver, 0);            
        ...
        public void TestLatestClosedPeriod()
        {
            ...
            EmployeeAccountsUtils.selectPeriodType(driver, 2);
        ...
        public void TestCurrentAndFuturePeriod()
        {
            ...
            EmployeeAccountsUtils.selectPeriodType(driver, 3);
